export const jobTitles = [
  ...
  "Disgraced Odor Judge",
  "Electrified Domino's Delivery Car",
  "Full Time Gimp",
  "Hungry For Small Change",
  "Guy Fieri's Bleach Poisoning",
  "Rush Roadie",
  "Old Youngman",
  ...
  "Oracle Of The Ugly",
  "Seaman",
  "Inappropriately Dressed For The Rapture",
  "Freezing Cold Mayor",
  "YouTube Deepfake Appraiser",
  "Gut Enthusiast",
  "Cream Denier",
  "Warm Beef",
  "Post Pubescant",
  "Justice Of The Feets",
  "Succession Season 2 Critic",
  "Apartment Spear Hunter",
  "Thighdiver",
  "Patron Saint Of Huffing Paint",
  "RateMyTeacher Admin",
  "Aquatic Hitman (Mer-Murderer)",
  "Disgraced Olympic Long Jumper (Spent Jump On Height)",
  "Equine Attorney",
  "Mortuary Ventriloquist",
  "Weather Woman",
  "Dean of Emissions",
  "Honey Ham Corporate Strategist",
  "Harper's Bizarre Adventure",
  ...
  "Monk With Blockbuster Late Fees",
  "Attitude Sickness",
  "The New Erotic Standard",
  "Saxophone Straightener (Too Curvy)",
  ...
  "Disney Adult Lawyer",
  "Book Club Promoter",
  "Pickleball Betting Ring Kingpin",
  "THE Final Fantasy",
  ...
  "Row Boat Hunk",
  "Wallace And Gromit Creepypasta Author",
  "Mansplayed And Neutered",
  "Orangutan From The Waist Up",
  "Esports Pastor",
  "Digimon Harassment Bureau",
  "Top 10 Viral Disease",
  "Fruit Stripe Gum Zebra",
  "Incurable Ham (The Butcher's Dilemma)",
  ...
  "Zanarkand Abes Striker",
  "Shortwave Midwife",
  "Doppler Seuss",
  "Investment Juggalo",
  "Real Life Scorpion King",
  "Crank 3: Higher Voltage",
  "2nd Most Neck Flaps (Lost To Butter Eater Bill)",
  "Depressionist",
  ...
  "Lustful Wench",
  "BMX Pleasure Technician",
  "Chipped And Loving It",
  "Essential Oil Spill",
  "Bar Mitzvah Jockey",
  "Ungovernable Ape",
  "Can I Sleep With You And Dad Tonight? I Had A Bad Dreamcast",
  "Thigh High Sock Puppet",
  "Chronically Underpaid",
  "Empty Mascot Costume Moving On Its Own",
  "Bitcoin Bitch",
  ...
  "Your Milkman",
  "69ing In A Trenchcoat",
  "Unfriendly Neighborhood Spy",
  "Local Coward",
  "Unsuccessful Clairvoyant",
  "Spectral Wedding Guest",
  "Ghost Officiant",
  "Distant Visible Imp",
  "Laser Lord",
  "Time Machine Saboteur",
  ...
  "As Above, So Behave",
  "French Catacombs Social Media Manager",
  ...
  "Blood Stooge",
  "Sandal Analyst",
  "Rising Gemini, Failing Mennonite",
  "Julius Caeser's Bodyguard (Let Go)",
  "That Watermelon Seed You Swallowed When You Were 10",
  "Giardia To The Stars",
  "Reproductive Liaison",
  ...
  "Agent Chody Danks",
  "Afterlife Coach",
  "The Big Lenscrafter's In The Sky",
  ...
  "Bose Fear-Canceling Headphones",
  "FitnessGRAM Pacer Test Voice",
  ...
  "Meerkat Manor Eviction Organizer",
  ...
  "Incel Me This Pen",
  "Death By Gex 64",
  "Begged For Money On Shark Tank (No Product)",
  "Deodorant Girl",
  ...
  "Professor Ex",
  "Lieutenant Dan's Baby Man",
  "Secular Art Dealer",
  "Chronic Scabs",
  "Chrysler 300 Simp",
  "Rheumatoid Car Flyness",
  "Thigh Gap Stooge",
  "Neck Skin Pulled Too Tight, Sailor's Delight",
  "Wears A G String (Groin Stream)",
  "Easy Mark",
  "Minions Themed Coffin",
  "Historic Disaster Site",
  "Mile Marker 69",
  "Handsome Cretin",
  "Experienced Blood Brother",
  "Splash Zone At The Bodies Exhibit",
  "My Son: The Rat",
  "Meconium Inspiration",
  "Parental Sunning",
  "Leslie Snipes",
];
